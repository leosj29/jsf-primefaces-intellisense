// JAKARTA FACES
import * as c4 from '../data/jakarta/c-4.0.json';
import * as cc4 from '../data/jakarta/cc-4.0.json';
...
import * as f from '../data/jsf/f.json';
import * as h from '../data/jsf/h.json';
import * as ui from '../data/jsf/ui.json';
// OMNIFACES
